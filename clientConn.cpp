...
*/
int Server::ClientConn::handleFileUpdate(msg::message2 msg, string buf){
...
(string) -> hash string or empty string in case of error.
...
-2 -> error parsing response into string
-3 -> unexpected error

*/
int Server::ClientConn::sendResponse(int resCode, string buf, msg::message2 msg) {
...
Convert the string received into a message object.
...
Convert the message received into a string, in order to be sent through a socket channel.
